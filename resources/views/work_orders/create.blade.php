<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Ajukan Work Order</h2>
    </x-slot>
                ...
                <form action="{{ route('work_orders.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="asset_id" id="asset_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <option value="">-- Pilih Asset yang Bermasalah --</option>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="4"
                                  placeholder="Jelaskan masalah yang terjadi pada asset ini secara detail..."
                    ...
                    <div class="flex justify-end space-x-2">
                        ...
                        <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700">Ajukan</button>
                    </div>
                </form>
            </div>
        </div>
