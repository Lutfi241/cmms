<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Spare Part</h2>
    </x-slot>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="minimum_stock" id="minimum_stock" value="{{ old('minimum_stock', 0) }}" min="0"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <p class="text-xs text-gray-400 mt-1">Peringatan muncul jika stok &le; nilai ini.</p>
                        </div>
                    </div>
