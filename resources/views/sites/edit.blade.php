            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('sites.update', $site) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="type" id="type" value="{{ old('type', $site->type) }}"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                    <div class="mb-4">
                        <label for="province" class="block text-sm font-medium text-gray-700">Provinsi (opsional)</label>
                        <input type="text" name="province" id="province" value="{{ old('province', $site->province) }}"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div class="flex justify-end space-x-2">
                        <a href="{{ route('sites.index') }}" class="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300">Batal</a>
